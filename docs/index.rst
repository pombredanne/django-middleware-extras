.. django-middleware-extras documentation master file, created by
   sphinx-quickstart on Sun Nov 14 09:50:21 2010.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

=========================
django-middleware-extras's documentation
=========================
...
Welcome to the *django-middleware-extras*'s documentation!
...
This guide provides an introduction to the *django-middleware-extras* |version| release,
